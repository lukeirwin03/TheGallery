...
var $ = class r {
  ...
  static fromHex(t) {
    ...
    if (typeof t == "string") {
      ...
      return new r(parseInt(c[1], 16), parseInt(c[2], 16), parseInt(c[3], 16));
  ...
  static fromHSL(t, c, w) {
    ...
    let S = o(
      ...
      q = S(K, L, t),
      Z = S(K, L, t - 1 / 3);
    return new r(Math.round(j * 255), Math.round(q * 255), Math.round(Z * 255));
  }
  ...
  lerp(t, c) {
    return new r(Se(this.r, t.r, c), Se(this.g, t.g, c), Se(this.b, t.b, c));
  }
  eq(t) {
...
function Dn(r, t) {
  ...
  for (let S = 0, L = w.length - 1; S < w.length; L = S++)
    w[S].y > t.y != w[L].y > t.y &&
      t.x < ((w[L].x - w[S].x) * (t.y - w[S].y)) / (w[L].y - w[S].y) + w[S].x &&
      (c = !c);
  return c;
}
...
function Gn(r, t) {
  ...
  if (c === "object" && w === "object" && r !== null && t !== null) {
    ...
    for (let K of S) {
      let j = r[K],
        q = t[K];
      if (!(typeof j == "function" && typeof q == "function") && !Gn(j, q))
        return !1;
    }
    return !0;
  }
...
var Qe = class {
  ...
  Rs = o((r) => {
      ...
      let x = 0,
        T = o((V) => {
          ...
          (t.realTime = ee),
            ...
            x > Ae &&
              (t.skipTime ||
                ((t.dt = x), (t.time += w()), t.fpsCounter.tick(t.dt)),
              (x = 0),
              (t.skipTime = !1),
              t.numFrames++,
              hn(),
    ...
    function Xt(l) {
      return l === void 0 ? t.keyState.down.size > 0 : t.keyState.down.has(l);
    }
    o(Xt, "isKeyDown");
    function nt(l) {
      return l === void 0
    ...
    let Qt = o((l, x) => {
      ...
      Zt = o((l, x) => {
        if (typeof l == "function") return t.events.on("keyPressRepeat", l);
        if (typeof l == "string" && typeof x == "function")
          return t.events.on("keyPressRepeat", (T) => T === l && x(l));
      }, "onKeyPressRepeat"),
      en = o((l, x) => {
    ...
    o(Et, "onShow");
    function St(l, x) {
      if (typeof l == "function") return t.events.on("gamepadButtonDown", l);
      if (typeof l == "string" && typeof x == "function")
        return t.events.on("gamepadButtonDown", (T) => T === l && x(l));
    }
    o(St, "onGamepadButtonDown");
    function Ct(l, x) {
      if (typeof l == "function") return t.events.on("gamepadButtonPress", l);
      if (typeof l == "string" && typeof x == "function")
        return t.events.on("gamepadButtonPress", (T) => T === l && x(l));
    }
    o(Ct, "onGamepadButtonPress");
    function Tt(l, x) {
      if (typeof l == "function") return t.events.on("gamepadButtonRelease", l);
      if (typeof l == "string" && typeof x == "function")
        return t.events.on("gamepadButtonRelease", (T) => T === l && x(l));
    }
    ...
    function hn() {
      t.events.trigger("input"),
        ...
        t.mouseState.down.forEach((l) => t.events.trigger("mouseDown", l)),
        dn();
    }
    o(hn, "processInput");
    function Ot() {
    ...
    function it(l) {
      let x = {
        ...
        isDown: (T) => t.gamepadStates.get(l.index).buttonState.down.has(T),
        isReleased: (T) =>
        ...
        for (let z = 0; z < x.buttons.length; z++)
          x.buttons[z].pressed
            ? (ee.buttonState.down.has(V.buttons[z]) ||
                (t.mergedGamepadState.buttonState.press(V.buttons[z]),
                ee.buttonState.press(V.buttons[z]),
                t.events.trigger("gamepadButtonPress", V.buttons[z])),
              t.events.trigger("gamepadButtonDown", V.buttons[z]))
            : ee.buttonState.down.has(V.buttons[z]) &&
              (t.mergedGamepadState.buttonState.release(V.buttons[z]),
              ee.buttonState.release(V.buttons[z]),
              t.events.trigger("gamepadButtonRelease", V.buttons[z]));
    ...
    (ce.keydown = (l) => {
      Mt.has(l.key) && l.preventDefault(),
        t.events.onOnce("input", () => {
          ...
          x.length === 1
            ? (t.events.trigger("charInput", x), t.charInputted.push(x))
            : x === "space" &&
      ...
      (ce.touchstart = (l) => {
        l.preventDefault(),
          t.events.onOnce("input", () => {
            ...
            r.touchToMouse !== !1 &&
              ((t.mousePos = new y(x[0].clientX - T.x, x[0].clientY - T.y)),
  ...
  $t = {
    ...
    easeInOutBack: (r) =>
      r < 0.5
        ...
        : (Math.pow(2 * r - 2, 2) * ((qt + 1) * (r * 2 - 2) + qt) + 2) / 2,
    easeInElastic: (r) =>
      r === 0
        ? 0
        : r === 1
    ...
    easeInOutElastic: (r) =>
      r === 0
        ...
        ? 1
        : r < 0.5
        ? -(Math.pow(2, 20 * r - 10) * Math.sin((20 * r - 11.125) * Fs)) / 2
        : (Math.pow(2, -20 * r + 10) * Math.sin((20 * r - 11.125) * Fs)) / 2 +
          1,
...
`,
  ...
  Gi = new Set(["add", "update", "draw", "destroy", "inspect", "drawInspect"]);
function et(r) {
  switch (r) {
    case "topleft":
      return new y(-1, -1);
...
var po = o((r = {}) => {
  ...
  class Q {
    ...
    update(n, s = 0, i = 0) {
      this.bind(),
        d.texSubImage2D(d.TEXTURE_2D, 0, s, i, d.RGBA, d.UNSIGNED_BYTE, n),
        this.unbind();
    }
    bind() {
  ...
  o(tt, "load");
  function Ce() {
    let e = [k.sprites, k.sounds, k.shaders, k.fonts, k.bitmapFonts, k.custom];
  ...
  function $e(e) {
    ...
    return (
      ...
      new Promise((s, i) => {
        (n.onload = () => s(n)),
          (n.onerror = () => i(new O(`Failed to load image from "${e}"`)));
      })
    );
  }
  o($e, "loadImg");
  ...
  function yt(e = 1, n = 1, s = 0, i = 0, a = 1, u = 1) {
    let f = [],
      ...
      m = u / n;
    for (let h = 0; h < n; h++)
      for (let g = 0; g < e; g++) f.push(new oe(s + g * p, i + h * m, p, m));
    return f;
  }
  o(yt, "slice");
  function xt(e, n) {
  ...
  function tn(e, n) {
    return k.sprites.add(
      ...
      new Promise(async (s) => {
        ...
        let p = await Le(null, u, { sliceY: i.frames.length, anims: i.anims });
        s(p);
      })
    );
  }
  ...
  function hn(e) {
    return (
      e !== void 0 && (ne.masterNode.gain.value = e), ne.masterNode.gain.value
    );
  }
  o(hn, "volume");
  function Ot(e, n = {}) {
    ...
    let E = o((D) => {
        (a.buffer = D.buf), i || ((m = s.currentTime), a.start(0, p), (g = !0));
      }, "start"),
      M = cn(e);
    ...
    return {
      ...
      set paused(D) {
        if (i !== D)
          if (((i = D), D)) g && (a.stop(), (g = !1)), (h = s.currentTime);
          else {
            a = _(a);
            let P = h - m;
            a.start(0, P), (g = !0), (m = s.currentTime - P), (h = 0);
          }
      },
      get paused() {
        return i;
  ...
  function me() {
    !v.curTex ||
      ...
      d.bufferSubData(d.ELEMENT_ARRAY_BUFFER, 0, new Uint16Array(v.iqueue)),
      v.curShader.bind(),
    ...
    if (e.tiled) {
      ...
      for (let h = 0; h < u; h++)
        for (let g = 0; g < f; g++)
          z(
            Object.assign({}, e, {
              pos: (e.pos || new y(0)).add(new y(s * h, i * g)).sub(m),
  ...
  function ct(e) {
    let { p1: n, p2: s } = e;
    if (!n || !s) throw new O('drawLine() requires properties "p1" and "p2".');
    let i = e.width || 1,
      a = s
        .sub(n)
        .unit()
      ...
      if (e.radius && n.length >= 3) {
        ...
        for (let s = 0; s < n.length - 1; s++)
          ct(Object.assign({}, e, { p1: n[s], p2: n[s + 1] })),
            e.join !== "none" &&
              ze(Object.assign({}, e, { pos: n[s], radius: e.width / 2 }));
  }
  o(Hn, "drawLines");
  function qn(e) {
    if (!e.p1 || !e.p2 || !e.p3)
      throw new O('drawPolygon() requires properties "p1", "p2" and "p3".');
  ...
  function $n(e) {
    if (e.radiusX === void 0 || e.radiusY === void 0)
      throw new O('drawEllipse() requires properties "radiusX" and "radiusY".');
  ...
  function Ie(e) {
    ...
    let n = e.pts.length;
    if (!(n < 3)) {
      if ((V(), l(e.pos), x(e.scale), T(e.angle), l(e.offset), e.fill !== !1)) {
        let s = e.color ?? $.WHITE,
          i = e.pts.map((u, f) => ({
            pos: new y(u.x, u.y),
            uv: new y(0, 0),
          ...
          a = [...Array(n - 2).keys()].map((u) => [0, u + 1, u + 2]).flat();
  ...
  function Ve(e) {
    ...
    if (n instanceof Ke || typeof n == "string") {
      let Y = n instanceof Ke ? n.fontface.family : n,
        ...
        I = fn[Y] ?? {
          font: { tex: new Q(Hs, qs, { filter: N.filter }), map: {}, size: Ns },
          cursor: new y(0),
          outline: N.outline,
        };
      ...
      for (let de of a)
        if (!I.font.map[de]) {
          ...
          I.outline &&
            ...
            (G += I.outline.width * 2),
            (B += I.outline.width * 3)),
            b.fillText(de, I.outline?.width ?? 0, I.outline?.width ?? 0);
...
`
    ...
    for (let Y of M) {
      ...
      for (let I of Y.chars) {
        let de = n.map[I.ch],
          b = se.length;
        if (
          ((I.pos = I.pos.add(N, 0).add(de.w * f.x * 0.5, de.h * f.y * 0.5)),
          e.transform)
        ) {
          let R =
  ...
  o(Gt, "mousePos"),
    (Ye.error = (e) => {
      e.error && e.error instanceof O ? Un(e.error) : e instanceof O && Un(e);
    }),
    ...
    let n = new Map(),
      ...
      p = {
        ...
        add(h = []) {
          ...
          if (g.parent)
            throw new O("Cannot add a game obj that already has a parent.");
          return (
            (g.parent = this),
            (g.transform = Ft(g)),
        ...
        readd(h) {
          ...
          return (
            g !== -1 && (this.children.splice(g, 1), this.children.push(h)), h
          );
        },
        remove(h) {
          let g = this.children.indexOf(h);
        ...
        draw() {
          ...
          this.fixed && (v.fixed = !0),
            ...
            x(this.scale),
            T(this.angle);
          let g = this.children.sort((E, M) => (E.z ?? 0) - (M.z ?? 0));
          if (this.mask) {
            let E = { intersect: zn, subtract: Yn }[this.mask];
            if (!E) throw new O(`Invalid mask func: "${this.mask}"`);
            E(
              () => {
                g.forEach((M) => M.draw());
              },
        ...
        use(h) {
          ...
          let g = [];
          h.id &&
            (this.unuse(h.id), (s[h.id] = []), (g = s[h.id]), n.set(h.id, h));
          for (let M in h) {
            if (Di.has(M)) continue;
            let F = Object.getOwnPropertyDescriptor(h, M);
            if (
              (typeof F.value == "function" && (h[M] = h[M].bind(this)),
              F.set && Object.defineProperty(h, M, { set: F.set.bind(this) }),
              F.get && Object.defineProperty(h, M, { get: F.get.bind(this) }),
              Gi.has(M))
            ) {
              let _ =
                M === "add"
                  ? () => {
                      (u = o((D) => g.push(D), "onCurCompCleanup")),
                        h[M](),
                        (u = null);
                    }
                  : h[M];
            ...
            else throw new O(`Duplicate component property: "${M}"`);
          }
          let E = o(() => {
            if (h.require) {
              for (let M of h.require)
                if (!this.c(M))
                  throw new O(`Component "${h.id}" requires component "${M}"`);
            }
          }, "checkDeps");
          h.destroy && g.push(h.destroy.bind(this)),
            this.exists()
              ? (E(),
                h.add &&
                  ((u = o((M) => g.push(M), "onCurCompCleanup")),
                  h.add.call(this),
                  (u = null)))
        ...
        get(h, g = {}) {
          let E = g.recursive
            ...
            : this.children;
          if (((E = E.filter((M) => (h ? M.is(h) : !0))), g.liveUpdate)) {
            let M = o(
              (F) => (g.recursive ? this.isAncestorOf(F) : F.parent === this),
              "isChild"
            );
            gn((F) => {
              M(F) && F.is(h) && E.push(F);
  ...
  function lr(e, n) {
    ...
    return (
      Bt(e, (i) => {
        if (!i.area)
          throw new O("onHover() requires the object to have area() component");
    ...
    return {
      ...
      drawInspect() {
        ...
        i instanceof he
          ...
          : i instanceof _e
          ? Ie({ ...a, pts: i.pts })
          : i instanceof gt && ze({ ...a, pos: i.center, radius: i.radius }),
          ee();
      },
      area: {
        shape: e.shape ?? null,
      ...
      onCollideUpdate(i, a) {
        ...
        if (typeof i == "string")
          return this.on("collideUpdate", (u, f) => u.is(i) && a(u, f));
      },
      onCollideEnd(i, a) {
        if (typeof i == "function" && a === void 0)
  ...
  function vn(e, n = {}) {
    let s = null,
      ...
      a = null,
      u = new ve();
    if (!e) throw new O("Please pass the resource name or data to sprite()");
    let f = o((p, m, h, g) => {
      let E = C(1, 1);
      return (
        h && g
          ? ((E.x = h / (p.width * m.w)), (E.y = g / (p.height * m.h)))
          : h
            ...
            (this.frame < Math.min(p.from, p.to) ||
              ...
              (i.loop
                ? i.pingpong
                  ...
                  : (this.frame = p.from)
                : ((this.frame = p.to), i.onEnd(), this.stop())));
      },
      play(p, m = {}) {
        if (!s) {
          u.add(() => this.play(p, m));
  ...
  function Pr(e, n) {
    return {
      ...
      height: n,
      draw() {
        z(Object.assign(Xe(this), { width: this.width, height: this.height }));
      },
      renderArea() {
        return new he(C(0), this.width, this.height);
      },
  ...
  function is() {
    return {
      ...
      wait(e, n) {
        ...
        let i = 0,
          a = this.onUpdate(() => {
            (i += Ue()), i >= e && (s.forEach((u) => u()), a.cancel());
          });
        return {
          get paused() {
            return a.paused;
        ...
        this.onCollideUpdate((u, f) => {
          if (
            ...
            if (!this.isStatic && !u.isStatic) {
              ...
              (this.pos = this.pos.add(f.displacement.scale(u.mass / p))),
                (u.pos = u.pos.add(f.displacement.scale(-this.mass / p))),
                (this.transform = Ft(this)),
                (u.transform = Ft(u));
            } else {
              let p = !this.isStatic && u.isStatic ? f : f.reverse();
          ...
          this.onPhysicsResolve((u) => {
            A.gravity &&
              (u.isBottom() && this.isFalling()
                ...
                : u.isTop() &&
                  this.isJumping() &&
                  ((n.y = 0), this.trigger("headbutt", u.target)));
          });
      },
      update() {
  ...
  o(os, "stay");
  function Vr(e) {
    if (e == null) throw new O("health() requires the initial amount of hp");
    let n = e;
    return {
      id: "health",
      hurt(s = 1) {
      ...
      _ = o(() => {
        ...
        for (let R of s.children) {
          ...
          (R.tilePos.x != G.x || R.tilePos.y != G.y) &&
            ((b = !0), F(R), (R.tilePos.x = G.x), (R.tilePos.y = G.y), M(R));
        }
      ...
      de = {
            ...
            B = (() => {
              if (typeof b == "string") {
                if (n.tiles[b]) {
                  ...
                  return n.tiles[b](G);
                } else if (n.wildcardTile) return n.wildcardTile(b, G);
              } else {
                if (Array.isArray(b)) return b;
                throw new O("Expected a symbol or a component list");
              }
            })();
          if (!B) return null;
          let H = !1,
        ...
        getPath(b, R, G = {}) {
          let B = this.tileWidth(),
            H = this.tileHeight(),
            X = this.getTilePath(this.pos2Tile(b), this.pos2Tile(R), G);
          return X
            ? [
                b,
                ...X.slice(1, -1).map((ie) => ie.scale(B, H).add(B / 2, H / 2)),
                R,
              ]
            : null;
        },
  ...
  function Wr(e) {
    ...
    return (
      ...
      (i.onerror = () => {
        ne.masterNode.disconnect(s), n.getTracks().forEach((u) => u.stop());
      }),
      i.start(),
      {
        resume() {
  ...
  function si(e, n = {}) {
    ...
    return (
      u.wait(0.4 / i, () => u.use(ls(i, a))), u.onDestroy(() => s.destroy()), s
    );
  }
  o(si, "addKaboom");
  function hs() {
        ...
        for (let _ = h; _ <= E; _++)
          for (let D = g; D <= M; D++)
            if (!e[_]) (e[_] = {}), (e[_][D] = [f]);
              ...
              let P = e[_][D];
              e: for (let se of P) {
                if (se.paused || !se.exists() || F.has(se.id)) continue;
                for (let N of f.collisionIgnore) if (se.is(N)) continue e;
                for (let N of se.collisionIgnore) if (f.is(N)) continue e;
                let Y = Ts(f.worldArea(), se.worldArea());
                if (Y) {
                  let N = new xn(f, se, Y);
                  f.trigger("collideUpdate", se, N);
                  let I = N.reverse();
                  (I.resolved = N.resolved), se.trigger("collideUpdate", f, I);
                }
                F.add(se.id);
              }
              P.push(f);
  ...
  function oi() {
    ...
    A.events.numListeners("loading") > 0
      ...
      : Fe(() => {
          ...
          xe({ pos: C(0), width: ge(), height: we(), color: W(0, 0, 0) }),
            xe({
              pos: i,
              width: n,
              height: s,
    ...
    te.paused &&
      ...
      te.showLog &&
        ...
        Fe(() => {
          ...
          A.logs = A.logs.filter((i) => U.time() - i.time < (r.logTime || Pi));
          let s = Ve({
            text: n.join(`
`),
            font: zt,
  ...
  function En(e, n, s, i, a = Ze.linear) {
    let u = 0,
      ...
      p = pn(() => {
        u += Ue();
        let m = Math.min(u / s, 1);
        i(Se(e, n, a(m))), m === 1 && (p.cancel(), i(n), f.forEach((h) => h()));
      });
    return {
      get paused() {
        return p.paused;
  ...
  U.run(() => {
    k.loaded ||
      ...
      (!k.loaded && r.loadingScreen !== !1) || jt
        ? (Te(), oi(), Mt())
        : (te.paused || hs(), ri(), Te(), ii(), r.debug !== !1 && ai(), Mt()),
      jt && (jt = !1),
  ...
  o(fs, "updateViewport"),
    ...
    U.onResize(() => {
      ...
      (e && !r.stretch && !r.letterbox) ||
        ...
        e ||
          (v.frameBuffer.free(),
          (v.frameBuffer = new Ge(d.drawingBufferWidth, d.drawingBufferHeight)),
          (v.width = d.drawingBufferWidth / j),
          (v.height = d.drawingBufferHeight / j)));
    }),
    fs();
